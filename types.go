...
type GeoIP struct {
	...
	// 地理位置信息
	Country     string  `json:"country,omitempty" maxminddb:"country"`      // 国家名称
	CountryCode string  `json:"country_code,omitempty" maxminddb:"cc"`      // 国家代码 (ISO 3166-1 alpha-2)
	Region      string  `json:"region,omitempty" maxminddb:"region"`        // 地区/省份名称
	RegionCode  string  `json:"region_code,omitempty" maxminddb:"rc"`       // 地区/省份代码
	City        string  `json:"city,omitempty" maxminddb:"city"`            // 城市名称
	Latitude    float64 `json:"latitude,omitempty" maxminddb:"lat"`         // 纬度
	Longitude   float64 `json:"longitude,omitempty" maxminddb:"lon"`        // 经度
	Postal      string  `json:"postal,omitempty" maxminddb:"postal"`        // 邮政编码
	Timezone    string  `json:"timezone,omitempty" maxminddb:"tz"`          // 时区

	// ASN 信息
	ASN    int    `json:"asn,omitempty" maxminddb:"asn"`         // 自治系统号
	ASName string `json:"as_name,omitempty" maxminddb:"as_name"` // 自治系统名称
	AS     string `json:"as,omitempty" maxminddb:"-"`            // AS 字符串表示 (如 "AS15169")

	// ISP 信息
	ISP string `json:"isp,omitempty" maxminddb:"isp"` // 互联网服务提供商
	Org string `json:"org,omitempty" maxminddb:"org"` // 组织名称

	// 其他信息
	Continent     string `json:"continent,omitempty" maxminddb:"continent"` // 大洲
	ContinentCode string `json:"continent_code,omitempty" maxminddb:"ccode"` // 大洲代码
	Proxy         bool   `json:"proxy,omitempty" maxminddb:"proxy"`         // 是否为代理/VPN
	Hosting       bool   `json:"hosting,omitempty" maxminddb:"hosting"`     // 是否为托管服务器
}
